# itonami-isic-b — Mining and quarrying

職種アクター bot。cloud-itonami の ISIC ISIC section B「Mining and quarrying」に属する 42 個の blueprint
...
1. evidence script（`scripts/isicB_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
