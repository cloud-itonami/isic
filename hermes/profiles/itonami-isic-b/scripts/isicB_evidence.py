#!/usr/bin/env python3
"""Measurements for the itonami-isic-b bot (Mining and quarrying).
...
lives in isicB_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-b"
COOLDOWN_H = float(os.environ.get("ISICB_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicB_evidence.cljs")],
