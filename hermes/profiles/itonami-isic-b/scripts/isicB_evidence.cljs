;; itonami-isic-b (Mining and quarrying) business bot — decision-free collector.
...
;; Run: nbb scripts/isicB_evidence.cljs
...
;; Mining and quarrying member blueprint repos (42).
(def members
  [510 520 561 562 563 610 620 649 710 721 729 750 791 810 851 852 853 854 855 861 862 869 871 872 873 879 889 891 892 893 899 900 910 920 931 932 941 942 949 952 960 990])
