# itonami-isic-h — Transport and storage

職種アクター bot。cloud-itonami の ISIC ISIC section H「Transport and storage」に属する 23 個の blueprint
...
1. evidence script（`scripts/isicH_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
