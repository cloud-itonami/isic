#!/usr/bin/env python3
"""Measurements for the itonami-isic-h bot (Transport and storage).
...
lives in isicH_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-h"
COOLDOWN_H = float(os.environ.get("ISICH_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicH_evidence.cljs")],
