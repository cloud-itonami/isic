# itonami-isic-c — Manufacturing

職種アクター bot。cloud-itonami の ISIC ISIC section C「Manufacturing」に属する 135 個の blueprint
...
1. evidence script（`scripts/isicC_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
