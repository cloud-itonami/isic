#!/usr/bin/env python3
"""Measurements for the itonami-isic-c bot (Manufacturing).
...
lives in isicC_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-c"
COOLDOWN_H = float(os.environ.get("ISICC_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicC_evidence.cljs")],
