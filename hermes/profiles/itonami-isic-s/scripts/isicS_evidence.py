#!/usr/bin/env python3
"""Measurements for the itonami-isic-s bot (Other service activities).
...
lives in isicS_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-s"
COOLDOWN_H = float(os.environ.get("ISICS_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicS_evidence.cljs")],
