# itonami-isic-s — Other service activities

職種アクター bot。cloud-itonami の ISIC ISIC section S「Other service activities」に属する 17 個の blueprint
...
1. evidence script（`scripts/isicS_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
