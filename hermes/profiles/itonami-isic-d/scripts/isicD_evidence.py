#!/usr/bin/env python3
"""Measurements for the itonami-isic-d bot (Electricity, gas, steam and air conditioning).
...
lives in isicD_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-d"
COOLDOWN_H = float(os.environ.get("ISICD_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicD_evidence.cljs")],
