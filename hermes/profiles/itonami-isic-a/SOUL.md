# itonami-isic-a — Agriculture, forestry and fishing

職種アクター bot。cloud-itonami の ISIC ISIC section A「Agriculture, forestry and fishing」に属する 38 個の blueprint
...
1. evidence script（`scripts/isicA_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
