#!/usr/bin/env python3
"""Measurements for the itonami-isic-a bot (Agriculture, forestry and fishing).
...
lives in isicA_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-a"
COOLDOWN_H = float(os.environ.get("ISICA_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicA_evidence.cljs")],
