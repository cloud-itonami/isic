# itonami-isic-r — Arts, entertainment and recreation

職種アクター bot。cloud-itonami の ISIC ISIC section R「Arts, entertainment and recreation」に属する 10 個の blueprint
...
1. evidence script（`scripts/isicR_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
