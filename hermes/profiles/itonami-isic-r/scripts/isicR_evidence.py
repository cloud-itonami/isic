#!/usr/bin/env python3
"""Measurements for the itonami-isic-r bot (Arts, entertainment and recreation).
...
lives in isicR_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-r"
COOLDOWN_H = float(os.environ.get("ISICR_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicR_evidence.cljs")],
