# itonami-isic-l — Real estate

職種アクター bot。cloud-itonami の ISIC ISIC section L「Real estate」に属する 2 個の blueprint
...
1. evidence script（`scripts/isicL_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
