#!/usr/bin/env python3
"""Measurements for the itonami-isic-l bot (Real estate).
...
lives in isicL_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-l"
COOLDOWN_H = float(os.environ.get("ISICL_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicL_evidence.cljs")],
