;; itonami-isic-i (Accommodation and food service) business bot — decision-free collector.
...
;; Run: nbb scripts/isicI_evidence.cljs
...
;; Accommodation and food service member blueprint repos (7).
(def members
  [5510 5520 5590 5610 5621 5629 5630])
