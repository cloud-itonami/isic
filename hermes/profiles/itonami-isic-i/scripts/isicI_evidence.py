#!/usr/bin/env python3
"""Measurements for the itonami-isic-i bot (Accommodation and food service).
...
lives in isicI_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-i"
COOLDOWN_H = float(os.environ.get("ISICI_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicI_evidence.cljs")],
