# itonami-isic-i — Accommodation and food service

職種アクター bot。cloud-itonami の ISIC ISIC section I「Accommodation and food service」に属する 7 個の blueprint
...
1. evidence script（`scripts/isicI_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
