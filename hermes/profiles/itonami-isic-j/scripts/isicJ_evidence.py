#!/usr/bin/env python3
"""Measurements for the itonami-isic-j bot (Information and communication).
...
lives in isicJ_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-j"
COOLDOWN_H = float(os.environ.get("ISICJ_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicJ_evidence.cljs")],
