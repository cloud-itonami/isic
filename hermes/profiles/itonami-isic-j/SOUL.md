# itonami-isic-j — Information and communication

職種アクター bot。cloud-itonami の ISIC ISIC section J「Information and communication」に属する 24 個の blueprint
...
1. evidence script（`scripts/isicJ_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
