#!/usr/bin/env python3
"""Measurements for the itonami-isic-t bot (Households as employers).
...
lives in isicT_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-t"
COOLDOWN_H = float(os.environ.get("ISICT_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicT_evidence.cljs")],
