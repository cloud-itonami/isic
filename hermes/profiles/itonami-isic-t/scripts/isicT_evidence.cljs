;; itonami-isic-t (Households as employers) business bot — decision-free collector.
...
;; Run: nbb scripts/isicT_evidence.cljs
...
;; Households as employers member blueprint repos (3).
(def members
  [9700 9810 9820])
