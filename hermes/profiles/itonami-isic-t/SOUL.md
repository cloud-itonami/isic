# itonami-isic-t — Households as employers

職種アクター bot。cloud-itonami の ISIC ISIC section T「Households as employers」に属する 3 個の blueprint
...
1. evidence script（`scripts/isicT_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
