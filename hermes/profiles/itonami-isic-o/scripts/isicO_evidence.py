#!/usr/bin/env python3
"""Measurements for the itonami-isic-o bot (Public administration and defence).
...
lives in isicO_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-o"
COOLDOWN_H = float(os.environ.get("ISICO_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicO_evidence.cljs")],
