# itonami-isic-o — Public administration and defence

職種アクター bot。cloud-itonami の ISIC ISIC section O「Public administration and defence」に属する 7 個の blueprint
...
1. evidence script（`scripts/isicO_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
