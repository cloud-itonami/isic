# itonami-isic-k — Financial and insurance

職種アクター bot。cloud-itonami の ISIC ISIC section K「Financial and insurance」に属する 19 個の blueprint
...
1. evidence script（`scripts/isicK_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
