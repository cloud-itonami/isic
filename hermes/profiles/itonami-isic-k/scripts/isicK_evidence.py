#!/usr/bin/env python3
"""Measurements for the itonami-isic-k bot (Financial and insurance).
...
lives in isicK_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-k"
COOLDOWN_H = float(os.environ.get("ISICK_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicK_evidence.cljs")],
