# itonami-isic-u — Extraterritorial organisations and bodies

職種アクター bot。cloud-itonami の ISIC ISIC section U「Extraterritorial organisations and bodies」に属する 1 個の blueprint
...
1. evidence script（`scripts/isicU_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
