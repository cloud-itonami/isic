#!/usr/bin/env python3
"""Measurements for the itonami-isic-u bot (Extraterritorial organisations and bodies).
...
lives in isicU_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-u"
COOLDOWN_H = float(os.environ.get("ISICU_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicU_evidence.cljs")],
