;; itonami-isic-u (Extraterritorial organisations and bodies) business bot — decision-free collector.
...
;; Run: nbb scripts/isicU_evidence.cljs
...
;; Extraterritorial organisations and bodies member blueprint repos (1).
(def members
  [9900])
