# itonami-isic-q — Human health and social work

職種アクター bot。cloud-itonami の ISIC ISIC section Q「Human health and social work」に属する 10 個の blueprint
...
1. evidence script（`scripts/isicQ_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
