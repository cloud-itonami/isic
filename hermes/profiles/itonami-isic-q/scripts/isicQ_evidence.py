#!/usr/bin/env python3
"""Measurements for the itonami-isic-q bot (Human health and social work).
...
lives in isicQ_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-q"
COOLDOWN_H = float(os.environ.get("ISICQ_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicQ_evidence.cljs")],
