# itonami-isic-f — Construction

職種アクター bot。cloud-itonami の ISIC ISIC section F「Construction」に属する 12 個の blueprint
...
1. evidence script（`scripts/isicF_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
