#!/usr/bin/env python3
"""Measurements for the itonami-isic-f bot (Construction).
...
lives in isicF_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-f"
COOLDOWN_H = float(os.environ.get("ISICF_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicF_evidence.cljs")],
