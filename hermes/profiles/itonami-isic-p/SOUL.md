# itonami-isic-p — Education

職種アクター bot。cloud-itonami の ISIC ISIC section P「Education」に属する 9 個の blueprint
...
1. evidence script（`scripts/isicP_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
