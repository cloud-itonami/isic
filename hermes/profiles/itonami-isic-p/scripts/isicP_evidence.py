#!/usr/bin/env python3
"""Measurements for the itonami-isic-p bot (Education).
...
lives in isicP_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-p"
COOLDOWN_H = float(os.environ.get("ISICP_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicP_evidence.cljs")],
