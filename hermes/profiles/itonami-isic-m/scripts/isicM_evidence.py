#!/usr/bin/env python3
"""Measurements for the itonami-isic-m bot (Professional, scientific and technical activities).
...
lives in isicM_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-m"
COOLDOWN_H = float(os.environ.get("ISICM_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicM_evidence.cljs")],
