# itonami-isic-m — Professional, scientific and technical activities

職種アクター bot。cloud-itonami の ISIC ISIC section M「Professional, scientific and technical activities」に属する 14 個の blueprint
...
1. evidence script（`scripts/isicM_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
