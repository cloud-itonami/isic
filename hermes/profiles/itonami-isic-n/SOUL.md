# itonami-isic-n — Administrative and support

職種アクター bot。cloud-itonami の ISIC ISIC section N「Administrative and support」に属する 26 個の blueprint
...
1. evidence script（`scripts/isicN_evidence.cljs`）の測定を読む。REFUSED / exit!=0 なら
   何もせず停止。
