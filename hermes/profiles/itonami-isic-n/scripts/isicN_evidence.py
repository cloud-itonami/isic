#!/usr/bin/env python3
"""Measurements for the itonami-isic-n bot (Administrative and support).
...
lives in isicN_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-n"
COOLDOWN_H = float(os.environ.get("ISICN_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicN_evidence.cljs")],
