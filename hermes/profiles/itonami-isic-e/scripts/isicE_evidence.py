#!/usr/bin/env python3
"""Measurements for the itonami-isic-e bot (Water supply; sewerage, waste).
...
lives in isicE_evidence.cljs (nbb); this wrapper exists because Hermes cron
...
JOB = "itonami-isic-e"
COOLDOWN_H = float(os.environ.get("ISICE_COOLDOWN_HOURS", "24"))
...
def main():
    ...
    proc = subprocess.run(
        [NBB, os.path.join(SCRIPT_DIR, "isicE_evidence.cljs")],
